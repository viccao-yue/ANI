# SPEC: BOSS maint-skills

> Technical specification derived from: `tasks/modules/prd/boss/health/prd-boss-maint-skills.md`  
...
收口 BOSS **运维与可观测 / 运维 Skills** 的权威源事实、平台级技术边界、Console 对照关系与 TODO-YAML 依赖。

### 1.2 PRD Reference

- Source: `tasks/modules/prd/boss/health/prd-boss-maint-skills.md`
- 主维护源: `docs/boss-modules/health/maint-skills.md`
...
| Core | GET | `/api/v1/tasks/{task_id}` | — | 执行结果关联只读参考 |

### 2.3 Non-Frozen Capabilities

- 平台 Skills list/execute — **TODO-YAML** P1
...
见主维护源 `docs/boss-modules/health/maint-skills.md`（§创建前置条件、§操作可用性矩阵）。
...
- `docs/boss-modules/health/maint-skills.md`
