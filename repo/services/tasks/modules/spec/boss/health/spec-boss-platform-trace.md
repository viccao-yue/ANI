# SPEC: BOSS platform-trace

> Technical specification derived from: `tasks/modules/prd/boss/health/prd-boss-platform-trace.md`  
...
收口 BOSS **运维与可观测 / Trace** 的权威源事实、平台级技术边界、Console 对照关系与 TODO-YAML 依赖。

### 1.2 PRD Reference

- Source: `tasks/modules/prd/boss/health/prd-boss-platform-trace.md`
- 主维护源: `docs/boss-modules/health/platform-trace.md`
...
| GET | `/api/v1/observability/query` | `queryObservability` | PromQL；**不是** Trace API |

### 2.3 Non-Frozen Capabilities

- 平台跨租户 trace — **TODO-YAML** P1
...
见主维护源 `docs/boss-modules/health/platform-trace.md`（§创建前置条件、§操作可用性矩阵）。
...
- `docs/boss-modules/health/platform-trace.md`
