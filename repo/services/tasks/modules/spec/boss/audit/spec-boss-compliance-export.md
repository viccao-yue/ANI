# SPEC: BOSS compliance-export

> Technical specification derived from: `tasks/modules/prd/boss/audit/prd-boss-compliance-export.md`  
...
收口 BOSS **安全审计与合规 / 合规导出与取证** 的权威源事实、平台级技术边界、Console 对照关系与 TODO-YAML 依赖。

### 1.2 PRD Reference

- Source: `tasks/modules/prd/boss/audit/prd-boss-compliance-export.md`
- 主维护源: `docs/boss-modules/audit/compliance-export.md`
...
- 平台级 `合规导出与取证` 跨租户 list/aggregate API — **TODO-YAML**
- BOSS 专属 RBAC scope — 待 Core/Services 确认
- 见主维护源

### 2.4 Core 同步边界（2026-06-17）

- 无 platform compliance export 冻结 path
- Console svc compliance — **草案/待 YAML**
- 导出 POST + AsyncTask — **TODO-YAML P2**
...
见主维护源 `docs/boss-modules/audit/compliance-export.md`（§创建前置条件、§操作可用性矩阵）。
...
- `docs/boss-modules/audit/compliance-export.md`
