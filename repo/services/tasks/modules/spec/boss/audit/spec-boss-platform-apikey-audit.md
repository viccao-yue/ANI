# SPEC: BOSS platform-apikey-audit

> Technical specification derived from: `tasks/modules/prd/boss/audit/prd-boss-platform-apikey-audit.md`  
...
收口 BOSS **安全审计与合规 / API Key 审计** 的权威源事实、平台级技术边界、Console 对照关系与 TODO-YAML 依赖。

### 1.2 PRD Reference

- Source: `tasks/modules/prd/boss/audit/prd-boss-platform-apikey-audit.md`
- 主维护源: `docs/boss-modules/audit/platform-apikey-audit.md`
...
- 平台级 `API Key 审计` 跨租户 list/aggregate API — **TODO-YAML**
- BOSS 专属 RBAC scope — 待 Core/Services 确认
- Core Auth 有 `/api/v1/auth/api-keys*`；跨租户审计 list 待补。

### 2.4 Core 同步边界（2026-06-17）

- 租户 `listAPIKeys` / `revokeAPIKey` — **只读参考**
- Console audit-events — **草案/待 YAML**
- 平台跨租户 list — **TODO-YAML P1**
...
见主维护源 `docs/boss-modules/audit/platform-apikey-audit.md`（§创建前置条件、§操作可用性矩阵）。
...
- `docs/boss-modules/audit/platform-apikey-audit.md`
