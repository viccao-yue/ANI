# SPEC: BOSS platform-inference-audit

> Technical specification derived from: `tasks/modules/prd/boss/audit/prd-boss-platform-inference-audit.md`  
...
收口 BOSS **安全审计与合规 / 推理调用审计** 的权威源事实、平台级技术边界、Console 对照关系与 TODO-YAML 依赖。

### 1.2 PRD Reference

- Source: `tasks/modules/prd/boss/audit/prd-boss-platform-inference-audit.md`
- 主维护源: `docs/boss-modules/audit/platform-inference-audit.md`
...
- 平台级 `推理调用审计` 跨租户 list/aggregate API — **TODO-YAML**
...
- `POST /metering/token-usage` — 上报非 BOSS list
- 禁止展示 prompt 全文
- 平台 inference audit list — **TODO-YAML P1**
...
见主维护源 `docs/boss-modules/audit/platform-inference-audit.md`（§创建前置条件、§操作可用性矩阵）。
...
- `docs/boss-modules/audit/platform-inference-audit.md`
