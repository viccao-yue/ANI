# SPEC: BOSS resource-capacity-trend

> Technical specification derived from: `tasks/modules/prd/boss/overview/prd-boss-resource-capacity-trend.md`  
...
收口 BOSS **平台运营总览 / 资源池与容量态势** 的权威源事实、平台级技术边界、Console 对照关系与 TODO-YAML 依赖。

### 1.2 PRD Reference

- Source: `tasks/modules/prd/boss/overview/prd-boss-resource-capacity-trend.md`
- 主维护源: `docs/boss-modules/overview/resource-capacity-trend.md`
...
| GET | `/api/v1/metering/usage` | — | 租户 **只读参考**；`group_by` 不含 `tenant_id` |
| GET | `/api/v1/observability/query` | `queryObservability` | PromQL |

平台 capacity aggregate — **TODO-YAML P1**

### 2.3 Non-Frozen Capabilities

- 平台级跨租户 capacity list/aggregate — **TODO-YAML** P1
- 平台 RBAC scope — **TODO-YAML**

### 2.4 Core 同步边界（2026-06-17）

- 租户已声明路径仅 **只读参考**；不得逐租户 JWT 轮询冒充平台大盘
...
见主维护源 `docs/boss-modules/overview/resource-capacity-trend.md`（§创建前置条件、§操作可用性矩阵）。
...
- `docs/boss-modules/overview/resource-capacity-trend.md`
