# SPEC: BOSS kb-ops-trend

> Technical specification derived from: `tasks/modules/prd/boss/overview/prd-boss-kb-ops-trend.md`  
...
收口 BOSS **平台运营总览 / 知识库运营态势** 的权威源事实、平台级技术边界、Console 对照关系与 TODO-YAML 依赖。

### 1.2 PRD Reference

- Source: `tasks/modules/prd/boss/overview/prd-boss-kb-ops-trend.md`
- 主维护源: `docs/boss-modules/overview/kb-ops-trend.md`
...
|---|---|---|---|
| GET | `/api/v1/svc/knowledge-bases` | `listKnowledgeBases` | 租户 **只读参考** |
| GET | `/api/v1/observability/query` | `queryObservability` | PromQL |
| GET | `/api/v1/metering/usage` | — | KB `resource_type` enum **TODO-YAML** |

平台 KB aggregate — **TODO-YAML P1**

### 2.3 Non-Frozen Capabilities

- 跨租户 KB 活跃排行 — **TODO-YAML** P1
- metering `kb_queries` resource_type — metering 域 **TODO-YAML**

### 2.4 Core 同步边界（2026-06-17）

- Services list — **租户只读参考**；禁止 JWT 轮询
...
见主维护源 `docs/boss-modules/overview/kb-ops-trend.md`（§创建前置条件、§操作可用性矩阵）。
...
- `docs/boss-modules/overview/kb-ops-trend.md`
