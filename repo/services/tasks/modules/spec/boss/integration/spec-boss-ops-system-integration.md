# SPEC: BOSS ops-system-integration

> Technical specification derived from: `tasks/modules/prd/boss/integration/prd-boss-ops-system-integration.md`  
...
收口 BOSS **平台集成与通知 / 运营系统对接** 的权威源事实、平台级技术边界、Console 对照关系与 TODO-YAML 依赖。

### 1.2 PRD Reference

- Source: `tasks/modules/prd/boss/integration/prd-boss-ops-system-integration.md`
- 主维护源: `docs/boss-modules/integration/ops-system-integration.md`
...
- 平台级 `运营系统对接` 跨租户 list/aggregate API — **TODO-YAML**
- BOSS 专属 RBAC scope — 待 Core/Services 确认
- 见主维护源

### 2.4 Core 同步边界（2026-06-17）

- 租户 listIntegrations/createIntegration — **只读参考**
- 无 `{integration_id}` path in YAML
- 平台跨租户集成治理 — **TODO-YAML P2**
...
见主维护源 `docs/boss-modules/integration/ops-system-integration.md`（§创建前置条件、§操作可用性矩阵）。
...
- `docs/boss-modules/integration/ops-system-integration.md`
