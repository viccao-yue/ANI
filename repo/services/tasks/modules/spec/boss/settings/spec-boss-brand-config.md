# SPEC: BOSS brand-config

> Technical specification derived from: `tasks/modules/prd/boss/settings/prd-boss-brand-config.md`  
...
收口 BOSS **交付与安装 / 品牌配置（Phase 2）** 的权威源事实、平台级技术边界、Console 对照关系与 TODO-YAML 依赖。

### 1.2 PRD Reference

- Source: `tasks/modules/prd/boss/settings/prd-boss-brand-config.md`
- 主维护源: `docs/boss-modules/settings/brand-config.md`
...
见主维护源 `docs/boss-modules/settings/brand-config.md`（§创建前置条件、§操作可用性矩阵）。
...
- `docs/boss-modules/settings/brand-config.md`
