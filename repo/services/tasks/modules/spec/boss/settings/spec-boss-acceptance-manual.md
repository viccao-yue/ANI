# SPEC: BOSS acceptance-manual

> Technical specification derived from: `tasks/modules/prd/boss/settings/prd-boss-acceptance-manual.md`  
...
收口 BOSS **交付与安装 / 交付验收手册** 的权威源事实、平台级技术边界、Console 对照关系与 TODO-YAML 依赖。

### 1.2 PRD Reference

- Source: `tasks/modules/prd/boss/settings/prd-boss-acceptance-manual.md`
- 主维护源: `docs/boss-modules/settings/acceptance-manual.md`
...
- 平台级 `交付验收手册` 跨租户 list/aggregate API — **TODO-YAML**
- BOSS 专属 RBAC scope — 待 Core/Services 确认
- 见主维护源

### 2.4 Core 同步边界（2026-06-17）

- 验收手册 REST — **TODO-YAML: N/A**
- ACC-* 用例为签署依据
- Console **无** 对等页
...
见主维护源 `docs/boss-modules/settings/acceptance-manual.md`（§创建前置条件、§操作可用性矩阵）。
...
- `docs/boss-modules/settings/acceptance-manual.md`
