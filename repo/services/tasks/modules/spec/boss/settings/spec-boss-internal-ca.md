# SPEC: BOSS internal-ca

> Technical specification derived from: `tasks/modules/prd/boss/settings/prd-boss-internal-ca.md`  
...
收口 BOSS **交付与安装 / 内部 CA** 的权威源事实、平台级技术边界、Console 对照关系与 TODO-YAML 依赖。

### 1.2 PRD Reference

- Source: `tasks/modules/prd/boss/settings/prd-boss-internal-ca.md`
- 主维护源: `docs/boss-modules/settings/internal-ca.md`
...
- 平台级 `内部 CA` 跨租户 list/aggregate API — **TODO-YAML**
- BOSS 专属 RBAC scope — 待 Core/Services 确认
- 证书管理属于交付/平台安全能力，当前不在 OpenAPI 中。

### 2.4 Core 同步边界（2026-06-17）

- 内部 CA REST — **TODO-YAML: N/A**
- 证书操作经 `ani-installer` Step 6
- Console **无** 对等页
...
见主维护源 `docs/boss-modules/settings/internal-ca.md`（§创建前置条件、§操作可用性矩阵）。
...
- `docs/boss-modules/settings/internal-ca.md`
