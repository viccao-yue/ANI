...
- 主维护源：[`docs/boss-modules/overview/operations-overview.md`](../../docs/boss-modules/overview/operations-overview.md)
- 当前无独立 BOSS 首页聚合接口；须并发读取各子模块已冻结或待补接口，在页面层做轻聚合。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `运营总览` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `运营总览` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/overview/operations-overview.md`](../../docs/boss-modules/overview/operations-overview.md)
- SPEC：[`tasks/modules/spec/boss/overview/spec-boss-operations-overview.md`](../../tasks/modules/spec/boss/overview/spec-boss-operations-overview.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/overview/operations-overview.md`](../../docs/boss-modules/overview/operations-overview.md)
- SPEC：[`spec-boss-operations-overview.md`](../spec/spec-boss-operations-overview.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.overview`
