...
- 主维护源：[`docs/boss-modules/overview/platform-alerts-pending.md`](../../docs/boss-modules/overview/platform-alerts-pending.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `平台告警与待处理` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `平台告警与待处理` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/overview/platform-alerts-pending.md`](../../docs/boss-modules/overview/platform-alerts-pending.md)
- SPEC：[`tasks/modules/spec/boss/overview/spec-boss-platform-alerts-pending.md`](../../tasks/modules/spec/boss/overview/spec-boss-platform-alerts-pending.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/overview/platform-alerts-pending.md`](../../docs/boss-modules/overview/platform-alerts-pending.md)
- SPEC：[`spec-boss-platform-alerts-pending.md`](../spec/spec-boss-platform-alerts-pending.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.overview.alerts`
