...
跨租户 API Key 创建、使用、吊销与异常调用审计；Console 侧见 api-key-audit。
...
- 主维护源：[`docs/boss-modules/audit/platform-apikey-audit.md`](../../docs/boss-modules/audit/platform-apikey-audit.md)
- Core Auth 有 `/api/v1/auth/api-keys*`；跨租户审计 list 待补。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `API Key 审计` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `API Key 审计` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/audit/platform-apikey-audit.md`](../../docs/boss-modules/audit/platform-apikey-audit.md)
- SPEC：[`tasks/modules/spec/boss/audit/spec-boss-platform-apikey-audit.md`](../../tasks/modules/spec/boss/audit/spec-boss-platform-apikey-audit.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/audit/platform-apikey-audit.md`](../../docs/boss-modules/audit/platform-apikey-audit.md)
- SPEC：[`spec-boss-platform-apikey-audit.md`](../spec/spec-boss-platform-apikey-audit.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.audit.apikey`
