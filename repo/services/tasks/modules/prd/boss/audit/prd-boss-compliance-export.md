...
- 主维护源：[`docs/boss-modules/audit/compliance-export.md`](../../docs/boss-modules/audit/compliance-export.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `合规导出与取证` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `合规导出与取证` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/audit/compliance-export.md`](../../docs/boss-modules/audit/compliance-export.md)
- SPEC：[`tasks/modules/spec/boss/audit/spec-boss-compliance-export.md`](../../tasks/modules/spec/boss/audit/spec-boss-compliance-export.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/audit/compliance-export.md`](../../docs/boss-modules/audit/compliance-export.md)
- SPEC：[`spec-boss-compliance-export.md`](../spec/spec-boss-compliance-export.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.audit.export`
