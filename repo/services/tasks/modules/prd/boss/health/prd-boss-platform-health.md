...
- 主维护源：[`docs/boss-modules/health/platform-health.md`](../../docs/boss-modules/health/platform-health.md)
- 可部分参考 `GET /api/v1/observability/query`；**无**独立 platform-health 聚合 API。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `平台健康` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `平台健康` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/health/platform-health.md`](../../docs/boss-modules/health/platform-health.md)
- SPEC：[`tasks/modules/spec/boss/health/spec-boss-platform-health.md`](../../tasks/modules/spec/boss/health/spec-boss-platform-health.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/health/platform-health.md`](../../docs/boss-modules/health/platform-health.md)
- SPEC：[`spec-boss-platform-health.md`](../spec/spec-boss-platform-health.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.health.services`
