...
通过 request_id 排查跨服务调用链，用于平台级故障定位。
...
- 主维护源：[`docs/boss-modules/health/platform-trace.md`](../../docs/boss-modules/health/platform-trace.md)
- Trace API 当前未在 v1.yaml 冻结。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `Trace` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `Trace` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/health/platform-trace.md`](../../docs/boss-modules/health/platform-trace.md)
- SPEC：[`tasks/modules/spec/boss/health/spec-boss-platform-trace.md`](../../tasks/modules/spec/boss/health/spec-boss-platform-trace.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/health/platform-trace.md`](../../docs/boss-modules/health/platform-trace.md)
- SPEC：[`spec-boss-platform-trace.md`](../spec/spec-boss-platform-trace.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.health.trace`
