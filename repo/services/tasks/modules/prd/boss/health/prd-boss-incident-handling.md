...
- 主维护源：[`docs/boss-modules/health/incident-handling.md`](../../docs/boss-modules/health/incident-handling.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `故障处理` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `故障处理` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/health/incident-handling.md`](../../docs/boss-modules/health/incident-handling.md)
- SPEC：[`tasks/modules/spec/boss/health/spec-boss-incident-handling.md`](../../tasks/modules/spec/boss/health/spec-boss-incident-handling.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/health/incident-handling.md`](../../docs/boss-modules/health/incident-handling.md)
- SPEC：[`spec-boss-incident-handling.md`](../spec/spec-boss-incident-handling.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.maint.incident`
