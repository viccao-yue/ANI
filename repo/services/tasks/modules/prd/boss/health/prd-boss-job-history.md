...
- 主维护源：[`docs/boss-modules/health/job-history.md`](../../docs/boss-modules/health/job-history.md)
- Console async-task-center 为租户视角；平台级跨租户 task list 待 Core 扩展。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `任务历史` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `任务历史` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/health/job-history.md`](../../docs/boss-modules/health/job-history.md)
- SPEC：[`tasks/modules/spec/boss/health/spec-boss-job-history.md`](../../tasks/modules/spec/boss/health/spec-boss-job-history.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/health/job-history.md`](../../docs/boss-modules/health/job-history.md)
- SPEC：[`spec-boss-job-history.md`](../spec/spec-boss-job-history.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.maint.jobs`
