...
- 主维护源：[`docs/boss-modules/health/alert-rules.md`](../../docs/boss-modules/health/alert-rules.md)
- Core 已声明 `GET/POST /api/v1/observability/alert-rules` 与 `{rule_id}` CRUD；平台级跨租户告警 list 与处置 API 待补。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `告警规则` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `告警规则` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/health/alert-rules.md`](../../docs/boss-modules/health/alert-rules.md)
- SPEC：[`tasks/modules/spec/boss/health/spec-boss-alert-rules.md`](../../tasks/modules/spec/boss/health/spec-boss-alert-rules.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/health/alert-rules.md`](../../docs/boss-modules/health/alert-rules.md)
- SPEC：[`spec-boss-alert-rules.md`](../spec/spec-boss-alert-rules.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.health.alerts`
