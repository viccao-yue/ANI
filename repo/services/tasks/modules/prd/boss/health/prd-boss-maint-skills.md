...
平台运维标准化 Skill 执行入口，将常见运维操作封装为可审计、可重试的工作流。
...
- 主维护源：[`docs/boss-modules/health/maint-skills.md`](../../docs/boss-modules/health/maint-skills.md)
- 运维 Skill 编排 API 当前未冻结；与 async-task 联动待设计。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `运维 Skills` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `运维 Skills` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/health/maint-skills.md`](../../docs/boss-modules/health/maint-skills.md)
- SPEC：[`tasks/modules/spec/boss/health/spec-boss-maint-skills.md`](../../tasks/modules/spec/boss/health/spec-boss-maint-skills.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/health/maint-skills.md`](../../docs/boss-modules/health/maint-skills.md)
- SPEC：[`spec-boss-maint-skills.md`](../spec/spec-boss-maint-skills.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.maint.skills`
