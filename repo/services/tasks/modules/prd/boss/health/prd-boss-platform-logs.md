...
- 主维护源：[`docs/boss-modules/health/platform-logs.md`](../../docs/boss-modules/health/platform-logs.md)
- 日志 list API 当前未在 v1.yaml 冻结；可规划对接 observability 或外部日志栈。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `日志` 的平台级摘要，以便判断全平台运行与风险。
...
- [`docs/boss-modules/health/platform-logs.md`](../../docs/boss-modules/health/platform-logs.md)
- SPEC：[`tasks/modules/spec/boss/health/spec-boss-platform-logs.md`](../../tasks/modules/spec/boss/health/spec-boss-platform-logs.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/health/platform-logs.md`](../../docs/boss-modules/health/platform-logs.md)
- SPEC：[`spec-boss-platform-logs.md`](../spec/spec-boss-platform-logs.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.health.logs`
