...
- 主维护源：[`docs/boss-modules/ops/platform-resource-pool.md`](../../docs/boss-modules/ops/platform-resource-pool.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `平台资源池总览` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `平台资源池总览` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/ops/platform-resource-pool.md`](../../docs/boss-modules/ops/platform-resource-pool.md)
- SPEC：[`tasks/modules/spec/boss/ops/spec-boss-platform-resource-pool.md`](../../tasks/modules/spec/boss/ops/spec-boss-platform-resource-pool.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/ops/platform-resource-pool.md`](../../docs/boss-modules/ops/platform-resource-pool.md)
- SPEC：[`spec-boss-platform-resource-pool.md`](../spec/spec-boss-platform-resource-pool.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.ops.pool`
