...
- 主维护源：[`docs/boss-modules/ops/gpu-pool-management.md`](../../docs/boss-modules/ops/gpu-pool-management.md)
- 可只读参考 Core `GET /api/v1/gpu-inventory` 与 `GET /api/v1/gpu-inventory/occupancy`（Phase 2 已声明，handler 待实现）；平台级跨租户聚合口径待补。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `GPU 资源池管理` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `GPU 资源池管理` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/ops/gpu-pool-management.md`](../../docs/boss-modules/ops/gpu-pool-management.md)
- SPEC：[`tasks/modules/spec/boss/ops/spec-boss-gpu-pool-management.md`](../../tasks/modules/spec/boss/ops/spec-boss-gpu-pool-management.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/ops/gpu-pool-management.md`](../../docs/boss-modules/ops/gpu-pool-management.md)
- SPEC：[`spec-boss-gpu-pool-management.md`](../spec/spec-boss-gpu-pool-management.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.ops.gpu`
