...
- 主维护源：[`docs/boss-modules/settings/hardware-check.md`](../../docs/boss-modules/settings/hardware-check.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `硬件检测` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `硬件检测` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/settings/hardware-check.md`](../../docs/boss-modules/settings/hardware-check.md)
- SPEC：[`tasks/modules/spec/boss/settings/spec-boss-hardware-check.md`](../../tasks/modules/spec/boss/settings/spec-boss-hardware-check.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/settings/hardware-check.md`](../../docs/boss-modules/settings/hardware-check.md)
- SPEC：[`spec-boss-hardware-check.md`](../spec/spec-boss-hardware-check.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.settings.hw_check`
