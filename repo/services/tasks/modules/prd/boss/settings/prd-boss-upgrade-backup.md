...
Phase 2 平台升级与备份管理，含 Patch 包上传、Dry-run 与升级历史。
...
- 主维护源：[`docs/boss-modules/settings/upgrade-backup.md`](../../docs/boss-modules/settings/upgrade-backup.md)
- 见 ANI-07 §7.3；Phase 2 预留。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `升级与备份` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `升级与备份` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/settings/upgrade-backup.md`](../../docs/boss-modules/settings/upgrade-backup.md)
- SPEC：[`tasks/modules/spec/boss/settings/spec-boss-upgrade-backup.md`](../../tasks/modules/spec/boss/settings/spec-boss-upgrade-backup.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/settings/upgrade-backup.md`](../../docs/boss-modules/settings/upgrade-backup.md)
- SPEC：[`spec-boss-upgrade-backup.md`](../spec/spec-boss-upgrade-backup.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.settings.upgrade`
