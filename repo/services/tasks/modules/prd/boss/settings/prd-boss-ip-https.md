...
- 主维护源：[`docs/boss-modules/settings/ip-https.md`](../../docs/boss-modules/settings/ip-https.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `纯 IP HTTPS` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `纯 IP HTTPS` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/settings/ip-https.md`](../../docs/boss-modules/settings/ip-https.md)
- SPEC：[`tasks/modules/spec/boss/settings/spec-boss-ip-https.md`](../../tasks/modules/spec/boss/settings/spec-boss-ip-https.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/settings/ip-https.md`](../../docs/boss-modules/settings/ip-https.md)
- SPEC：[`spec-boss-ip-https.md`](../spec/spec-boss-ip-https.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.settings.ip_https`
