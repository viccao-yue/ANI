...
- 主维护源：[`docs/boss-modules/settings/baremetal-deploy.md`](../../docs/boss-modules/settings/baremetal-deploy.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `裸机部署` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `裸机部署` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/settings/baremetal-deploy.md`](../../docs/boss-modules/settings/baremetal-deploy.md)
- SPEC：[`tasks/modules/spec/boss/settings/spec-boss-baremetal-deploy.md`](../../tasks/modules/spec/boss/settings/spec-boss-baremetal-deploy.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/settings/baremetal-deploy.md`](../../docs/boss-modules/settings/baremetal-deploy.md)
- SPEC：[`spec-boss-baremetal-deploy.md`](../spec/spec-boss-baremetal-deploy.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.settings.baremetal`
