...
管理内部 CA、证书下载与纯 IP HTTPS 访问所需的根证书分发。
...
- 主维护源：[`docs/boss-modules/settings/internal-ca.md`](../../docs/boss-modules/settings/internal-ca.md)
- 证书管理属于交付/平台安全能力，当前不在 OpenAPI 中。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `内部 CA` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `内部 CA` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/settings/internal-ca.md`](../../docs/boss-modules/settings/internal-ca.md)
- SPEC：[`tasks/modules/spec/boss/settings/spec-boss-internal-ca.md`](../../tasks/modules/spec/boss/settings/spec-boss-internal-ca.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/settings/internal-ca.md`](../../docs/boss-modules/settings/internal-ca.md)
- SPEC：[`spec-boss-internal-ca.md`](../spec/spec-boss-internal-ca.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.settings.ca`
