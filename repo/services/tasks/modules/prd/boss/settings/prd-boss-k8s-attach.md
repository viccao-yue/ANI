...
- 主维护源：[`docs/boss-modules/settings/k8s-attach.md`](../../docs/boss-modules/settings/k8s-attach.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `已有 K8s 接入` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `已有 K8s 接入` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/settings/k8s-attach.md`](../../docs/boss-modules/settings/k8s-attach.md)
- SPEC：[`tasks/modules/spec/boss/settings/spec-boss-k8s-attach.md`](../../tasks/modules/spec/boss/settings/spec-boss-k8s-attach.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/settings/k8s-attach.md`](../../docs/boss-modules/settings/k8s-attach.md)
- SPEC：[`spec-boss-k8s-attach.md`](../spec/spec-boss-k8s-attach.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.settings.k8s_attach`
