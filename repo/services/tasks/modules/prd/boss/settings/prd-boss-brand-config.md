...
Phase 2 BOSS 白牌化配置页，动态加载平台名称、Logo、主题色等。
...
- 主维护源：[`docs/boss-modules/settings/brand-config.md`](../../docs/boss-modules/settings/brand-config.md)
- 见 ANI-07 §8 BOSS 白牌化；Phase 2 预留。
...
作为平台管理员/SRE，我希望在 BOSS 查看 `品牌配置` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `品牌配置` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/settings/brand-config.md`](../../docs/boss-modules/settings/brand-config.md)
- SPEC：[`tasks/modules/spec/boss/settings/spec-boss-brand-config.md`](../../tasks/modules/spec/boss/settings/spec-boss-brand-config.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/settings/brand-config.md`](../../docs/boss-modules/settings/brand-config.md)
- SPEC：[`spec-boss-brand-config.md`](../spec/spec-boss-brand-config.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.settings.brand`
