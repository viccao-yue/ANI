...
- 主维护源：[`docs/boss-modules/settings/gpu-driver-install.md`](../../docs/boss-modules/settings/gpu-driver-install.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `GPU 驱动安装` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `GPU 驱动安装` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/settings/gpu-driver-install.md`](../../docs/boss-modules/settings/gpu-driver-install.md)
- SPEC：[`tasks/modules/spec/boss/settings/spec-boss-gpu-driver-install.md`](../../tasks/modules/spec/boss/settings/spec-boss-gpu-driver-install.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/settings/gpu-driver-install.md`](../../docs/boss-modules/settings/gpu-driver-install.md)
- SPEC：[`spec-boss-gpu-driver-install.md`](../spec/spec-boss-gpu-driver-install.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.settings.driver`
