# PRD: BOSS 平台 Storage-GBDays

## 1. 页面定位

BOSS / 平台计量与结算 / 平台 Storage-GBDays 平台侧页面。
...
- 主维护源：[`docs/boss-modules/metering/platform-storage-gbdays.md`](../../docs/boss-modules/metering/platform-storage-gbdays.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `平台 Storage-GBDays` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `平台 Storage-GBDays` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/metering/platform-storage-gbdays.md`](../../docs/boss-modules/metering/platform-storage-gbdays.md)
- SPEC：[`tasks/modules/spec/boss/metering/spec-boss-platform-storage-gbdays.md`](../../tasks/modules/spec/boss/metering/spec-boss-platform-storage-gbdays.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/metering/platform-storage-gbdays.md`](../../docs/boss-modules/metering/platform-storage-gbdays.md)
- SPEC：[`spec-boss-platform-storage-gbdays.md`](../spec/spec-boss-platform-storage-gbdays.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.metering.storage_days`
