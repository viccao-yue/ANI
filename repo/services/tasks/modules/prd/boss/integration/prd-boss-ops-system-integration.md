...
- 主维护源：[`docs/boss-modules/integration/ops-system-integration.md`](../../docs/boss-modules/integration/ops-system-integration.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `运营系统对接` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `运营系统对接` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/integration/ops-system-integration.md`](../../docs/boss-modules/integration/ops-system-integration.md)
- SPEC：[`tasks/modules/spec/boss/integration/spec-boss-ops-system-integration.md`](../../tasks/modules/spec/boss/integration/spec-boss-ops-system-integration.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/integration/ops-system-integration.md`](../../docs/boss-modules/integration/ops-system-integration.md)
- SPEC：[`spec-boss-ops-system-integration.md`](../spec/spec-boss-ops-system-integration.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.integration.third_party`
