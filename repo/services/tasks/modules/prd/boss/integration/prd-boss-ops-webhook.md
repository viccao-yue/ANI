...
- 主维护源：[`docs/boss-modules/integration/ops-webhook.md`](../../docs/boss-modules/integration/ops-webhook.md)
...
作为平台管理员/SRE，我希望在 BOSS 查看 `运维 Webhook` 的平台级摘要，以便判断全平台运行与风险。
...
- FR-1：必须定义 `运维 Webhook` 的 BOSS 页面定位与非目标
...
- [`docs/boss-modules/integration/ops-webhook.md`](../../docs/boss-modules/integration/ops-webhook.md)
- SPEC：[`tasks/modules/spec/boss/integration/spec-boss-ops-webhook.md`](../../tasks/modules/spec/boss/integration/spec-boss-ops-webhook.md)

## 10. 文档同步状态

- 同步日期：**2026-06-17**
- 详文状态：**满配（Core）** — [`docs/boss-modules/integration/ops-webhook.md`](../../docs/boss-modules/integration/ops-webhook.md)
- SPEC：[`spec-boss-ops-webhook.md`](../spec/spec-boss-ops-webhook.md)
- HTML 摘要：[`ani-services-prototype-boss.html`](../../prototypes/ani-services-prototype-boss.html) · `boss.integration.webhook`
