# PRD: Console integration-ts-client

详文：`docs/console-modules/integration/integration-ts-client.md` · P2 文档收口（2026-06-17）。

## 目标

- 为导航 **开放与集成 / TypeScript Client** 提供可维护的产品边界说明
